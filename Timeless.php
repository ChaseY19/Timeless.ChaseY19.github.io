...
<body>
  <div class="app">
    ...
    <div class="sidebar desktop-only">
      <div class="sidebar__logo">
        ...
        <span class="sidebar__title">Timeless Calendar</span>
      </div>

      <!-- Botón crear evento -->
      <button class="button button--primary button--lg" data-event-create-button>Crear evento</button>
      ...
      <div class="mini-calendar" data-mini-calendar>
        ...
        <div class="mini-calendar__content">
          <ul class="mini-calendar__day-of-week-list">
            ...
            <li class="mini-calendar__day-of-week">Mi</li>
  ...
  <!-- Botón flotante (móvil) para crear evento -->
  ...
  <!-- Diálogo del formulario de evento -->
  <dialog class="dialog" data-dialog="event-form">
    <form class="form" data-event-form>
      <div class="dialog__wrapper">
        ...
        <div class="dialog__content">
          <div class="form__fields">
            ...
            <div class="form__field">
              <label class="form__label" for="title">Titulo</label>
              <input class="input input--fill" id="title" name="title" type="text" placeholder="¡Mi gran evento!"
                required autofocus />
            </div>
            ...
            <div class="form__split">
              <div class="form__field">
                <label class="form__label" for="start-time">Desde</label>
              ...
              <!-- Campo hora de fin -->
              <div class="form__field">
                <label class="form__label" for="end-time">Hasta</label>
                <div class="select select--fill">
                  <select class="select__select" id="end-time" name="end-time">
                  <!-- Opciones cada 30 min -->  
                  <option value="30">12:30 AM</option>
                    <option value="60">1:00 AM</option>
                    <option value="90">1:30 AM</option>
                    <option value="120">2:00 AM</option>
        ...
        <!-- Pie del diálogo del formulario -->
  ...
  <!-- Diálogo: detalles del evento -->
  <dialog class="dialog" data-dialog="event-details">
    <div class="dialog__wrapper">
      <!-- Encabezado -->
      <div class="dialog__header">
        <h2 class="dialog__title">Detalles del evento</h2>
  ...
  <dialog class="dialog" data-dialog="event-delete">
    <div class="dialog__wrapper">
      <div class="dialog__header">
        <h2 class="dialog__title">Eliminar evento</h2>
      ...
      <!-- Confirmación -->
      <div class="dialog__content">
        <p>¿De verdad quieres eliminar <strong data-event-delete-title></strong>?</p>
      </div>
        ...
        <div class="mini-calendar" data-mini-calendar>
          <div class="mini-calendar__header">
            ...
            <div class="mini-calendar__controls">
              ...
              <!-- Botón: siguiente (mini calendario) -->
              <button class="button button--icon button--secondary button--sm" data-mini-calendar-next-button>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                  class="button__icon">
          ...
          <div class="mini-calendar__content">
            ...
            <!-- Lista de días (se rellena por JS) -->
            <ul class="mini-calendar__day-list" data-mini-calendar-day-list></ul>
          </div>
        </div>
      </div>
  ...
  <template data-template="month-calendar">
    <div class="month-calendar" data-month-calendar>
      <!-- Encabezados de días completos -->
      <ul class="month-calendar__day-of-week-list">
        <li class="month-calendar__day-of-week">Domingo</li>
        <li class="month-calendar__day-of-week">Lunes</li>
        <li class="month-calendar__day-of-week">Martes</li>
        <li class="month-calendar__day-of-week">Miércoles</li>
        <li class="month-calendar__day-of-week">Jueves</li>
        <li class="month-calendar__day-of-week">Viernes</li>
        <li class="month-calendar__day-of-week">Sábado</li>
      </ul>

      <!-- Contenedor scroll de días -->
    ...
    <ul class="week-calendar__day-of-week-list" data-week-calendar-day-of-week-list>
      ...
      <div class="week-calendar__content">
        ...
        <ul class="week-calendar__time-list">
          ...
          <!-- Columnas para eventos (slots por hora) -->
  ...
  <!-- Plantilla: encabezado día de semana -->
  ...
  <!-- Plantilla: lista de todo el día -->
  ...
  <!-- Plantilla: columna con celdas (intervalos de 60 min) -->
  ...
  <!-- Plantilla: item en lista de eventos -->
  ...
  <!-- Plantilla: día en mini calendario -->
